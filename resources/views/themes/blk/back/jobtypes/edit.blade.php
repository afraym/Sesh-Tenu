		...
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title">Edit Job Type / تعديل نوع الوظيفة</h4>
				</div>
				<div class="card-body">
					<form action="{{ route('jobtypes.update', $jobtype->id) }}" method="POST">
								...
								<div class="form-group">
									...
									<div class="form-check form-check-inline">
										<label class="form-check-label" for="is_active">
											Active / نشط
											<input class="form-check-input" type="checkbox" id="is_active" name="is_active" value="1" {{ old('is_active', $jobtype->is_active) ? 'checked' : '' }}>
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea class="form-control @error('description') is-invalid @enderror"
											  ...
											  rows="4"
											  placeholder="Enter description">{{ old('description', $jobtype->description) }}</textarea>
									@error('description')
										<span class="invalid-feedback">{{ $message }}</span>
									@enderror
								</div>
						...
						<div class="form-group mt-3">
							<button type="submit" class="btn btn-primary">
								<i class="tim-icons icon-refresh-02"></i> Update Job Type
							</button>
