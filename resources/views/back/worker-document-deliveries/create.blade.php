        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">إضافة تسليم سيركي جديد</h4>
                </div>
                <div class="card-body">
                    <form action="{{ route('worker-document-deliveries.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('morning_delivery_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('morning_delivery_date') }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control @error('evening_delivery_date') is-invalid @enderror" 
                                           ...
                                           value="{{ old('evening_delivery_date') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" 
                                              id="notes" name="notes" rows="3" placeholder="أدخل أي ملاحظات">{{ old('notes') }}</textarea>
                                    @error('notes')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary">
                                <i class="tim-icons icon-single-copy-04"></i> حفظ
                            </button>
